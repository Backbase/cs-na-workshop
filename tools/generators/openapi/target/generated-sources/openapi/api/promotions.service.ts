...
export class PromotionsHttpService {
  ...
  constructor(
    ...
    @Optional() @Inject(NGRX_PROMOTIONS_BASE_PATH) basePath: string,
    @Optional() configuration: NgrxPromotionsConfiguration,
  ) {
    if (configuration) {
   ...
   */
  public submitPromotionForm(
    requestParameters: SubmitPromotionFormRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<Array<Promotion>>;
  public submitPromotionForm(
    requestParameters: SubmitPromotionFormRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<HttpResponse<Array<Promotion>>>;
  public submitPromotionForm(
    requestParameters: SubmitPromotionFormRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<HttpEvent<Array<Promotion>>>;
  public submitPromotionForm(
    requestParameters: SubmitPromotionFormRequestParams,
    observe: any = 'body',
    ...
    return this.httpClient.post<Array<Promotion>>(
      `${this.configuration.basePath}/promotions/submit`,
